report 50003 "Delivery Note SSE"
{
    RDLCLayout = './src/Reports/Layout/50003.DeliveryNote.rdl';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(Delivery_Note_No; Header."Delivery Note No.")
            {
            ...
            column(Invoice_Lbl; DeliveryNotelbl)
            {
            }
    ...
    var
        Hidevalue: Boolean;
        DeliveryNoteLbl: Label 'Delivery Note';
