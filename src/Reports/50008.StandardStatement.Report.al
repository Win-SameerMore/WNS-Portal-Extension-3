report 50008 "Standard Statement - SSE"
{
    RDLCLayout = './src/Reports/Layout/50008.StandardStatement.rdl';
    WordLayout = './src/Reports/Layout/StandardStatementSSE.docx';
    Caption = 'Standard Statement - SSE';
    DefaultLayout = Word;
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(CustLedgEntryHdr; "Integer")
                    {
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            column(ExtDocNo; CustLedgerEntry."External Document No.")
                            {
    ...
    procedure SetVariables(dtStartDate: Date; dtEndDate: Date; ShowOrderDue: Boolean; IncludeAllCustomerswithBalance: Boolean; AddAgeingBand: Boolean)
    begin
        StartDate := dtStartDate;
        EndDate := dtEndDate;
        PrintEntriesDue := ShowOrderDue;
        PrintAllHavingBal := IncludeAllCustomerswithBalance;
        IncludeAgingBand := AddAgeingBand;
    end;
