report 50000 "Sales - Quote SSE"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports/Layout/50000.Sales_Quote.rdl';
    Caption = 'Sales - Quote SSE';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(SellToContactPhone; SellToContact."Phone No.")
            {

            }
            column(SellToContactFax; SellToContact."Fax No.")
            {

            }
            column(SellToContactMail; SellToContact."E-Mail")
            {
            ...
            //New Fields WIN504>>
            column(Quotation_Validity; "Quotation Validity")
            {
            ...
            column(SQTerms1; SalesSetup."Sales Quote Terms 1")
            {

            }
            column(SQTerms2; SalesSetup."Sales Quote Terms 2")
            {
            ...
            column(ChineseCompName; CompanyInfo."Chinese Company Name")
            {
            }
            column(ChineseCompAdd1; CompanyInfo."Chinese Company Address 1")
            {

            }
            column(ChineseCompAdd2; CompanyInfo."Chinese Company Address 2")
            {

            }
            column(ChineseCompCity; CompanyInfo."Chinese City")
            {

            }
            column(ExtraCompAdd1; CompanyInfo."Extra Address 1")
            {

            }
            column(ExtraCompAdd2; CompanyInfo."Extra Address 2")
            {

            }
            column(ExtraCompCity; CompanyInfo."Extra City")
            {

            }
            column(ExtraCompPostCode; CompanyInfo."Extra Post Code")
            {
            ...
            column(ExtraCompTel; CompanyInfo."Extra Telephone")
            {

            }
            column(ExtraCompFax; CompanyInfo."Extra Fax")
            {
            ...
            column(ContPhone; rContact."Phone No.")
            {

            }
            column(ContFax; rContact."Fax No.")
            {

            }
            column(ContEmail; rContact."E-Mail")
            {

            }
            column(Versions; "sales header"."No. of Archived Versions")
            {
            ...
            column(Cust_RFQ__No_; "Cust RFQ. No.")
            {

            }
            column(SystemCreatedBy; "Sales Header"."End User")
            {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(CustAddr2; "Sales Header"."Bill-to Address")
                    {
                    }
                    column(CompanyAddr2; CompanyAddr[2])
                    {
                    }
                    column(CustAddr3; "Sales Header"."Bill-to Address 2")
                    {
                    }
                    ...
                    column(BillToCountry; countries.Name)
                    {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        begin
                            ...
                            if Salesline.type = salesline.Type::Item then
                                if SalesLine."No." <> xItemNo then
                                    intSrNo += 1;
                            xItemNo := SalesLine."No.";
                            //WIN504 SRNO<<
                        end;
                ...
                begin
                    ...
                    //WIN504>>
                    if Countries.get("Sales Header"."Bill-to Country/Region Code") then;
                    if rContact.get("Sales Header"."Bill-to Contact No.") then;
                    //WIN504<<
                end;
            ...
            begin
                ...
                SellToContact.reset();
                SellToContact.SetRange("No.", "Sell-to Contact No.");
                if SellToContact.FindFirst() then;
    ...
    var
        ...
        CurrCode: Code[20];
        Text004: Label 'Sales Quotation %1', Comment = '%1 = Document No.';
