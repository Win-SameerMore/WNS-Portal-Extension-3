report 50004 "Delivery Order SSE"
{
    RDLCLayout = './src/Reports/Layout/50004.DeliveryOrder.rdl';
    Caption = 'Delivery Note SSE';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Header; "Sales Shipment Header")
        {
            ...
            column(CompPicture; CompanyInfo.Picture) { }            //WIN504<<
            ...
            column(CustomerAddress1; header."Bill-to Name") { }
            column(CustomerAddress2; header."Bill-to Address") { }
            column(CustomerAddress3; header."Bill-to Address 2") { }
            column(CustomerAddress4; Country.name + ' ' + header."Bill-to Post Code") { }
            column(CustomerAddress5; BillToContact."Phone No.") { }
            column(CustomerAddress6; header."Bill-to Contact") { }
            column(CustomerAddress7; header."Bill-to Contact") { }
            column(CustomerAddress8; header."Bill-to Contact") { }
            ...
            column(ShipToAddress1; header."Ship-to Name")
            {
            }
            column(ShipToAddress2; header."Ship-to Address")
            {
            }
            column(ShipToAddress3; header."Ship-to Address 2")
            {
            }
            column(ShipToAddress4; Country1.Name + ' ' + Header."Ship-to Post Code")
            {
            }
            column(ShipToAddress5; '')
            {
            }
            column(ShipToAddress6; header."Ship-to Contact")
            {
            }
            ...
            column(Invoice_Lbl; DeliveryOrdLbl)
            {
            }
            ...
            begin
                ...
                if Header."Salesperson Code" <> '' then
                    SalespersonPurchaser.Get(Header."Salesperson Code");
                ...
                Country.Reset();
                Country.SetRange(Code, Header."Bill-to Country/Region Code");
                if Country.FindFirst() then;

                Country1.Reset();
                Country1.SetRange(Code, Header."Ship-to Country/Region Code");
                if Country1.FindFirst() then;
            end;
        }
    }
    ...
    var
        ...
        DeliveryOrdLbl: Label 'Delivery Order';
