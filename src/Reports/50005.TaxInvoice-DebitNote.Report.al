report 50005 "Tax - Invoice"
{
    RDLCLayout = './src/Reports/Layout/50005.TaxInvoice.rdl';
    Caption = 'Tax - Invoice';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(CompPicture; DummyCompanyInfo.Picture) { }
            ...
            column(CompISONo; CompanyInfo."ISO No.") { }            //WIN504>>
            ...
            column(ShipToCountry; ShipToCountry) { }            //WIN504<<
            ...
            column(txtTotalVATAmountText; Vat_Per) { }
            ...
            begin
                ...
                //WIN504>>
                rSalesInvLine.reset;
                rSalesInvLine.SetRange("Document No.", Header."No.");
                if rSalesInvLine.FindSet() then
                    repeat
                        TotalSubAmount += rSalesInvLine."Line Amount";
                        TotalTaxAmount += rSalesInvLine."Amount Including VAT" - rsalesInvline.Amount;
                        TotalInvAmount += rSalesInvLine."Amount Including VAT";
                    until rSalesInvLine.Next = 0;
                TotalVATAmountText := VATAmountLine.VATAmountText;
                //WIN504<<

                /*  if VATAmountLine."VAT Amount" <> 0 then
                     VAT_Per := VATAmountLine."VAT %"
                 else
                     VAT_Per := 0; */

                if "Amount Including VAT" - Amount <> 0 then
                    Vat_Per := Round(("Amount Including VAT" - Amount) / "Amount Including VAT" * 100)
            end;
    ...
    trigger OnPreReport()
    begin
        if ReportOption = ReportOption::"DEBIT NOTE" then begin
            Invoice_Lbl := 'DEBIT NOTE'
        end else
            if ReportOption = ReportOption::"TAX INVOICE" then begin
                Invoice_Lbl := 'TAX INVOICE';
            end;
    ...
    var
        ...
        LCYCurrCode: code[20];
        Vat_Per: Decimal;
        ReportOption: Option "TAX INVOICE","DEBIT NOTE";
        Invoice_Lbl: text;
        ...
        rSalesInvLine: Record "Sales Invoice line";
    ...
    begin
        ...
        CustAddr[4] := BillToCountry + ' ' + SalesInvoiceHeader."Bill-to Post Code";
        CustAddr[5] := BillToContact."Phone No.";
        CustAddr[6] := SalesInvoiceHeader."Bill-to Contact";
        ...
        ShipToAddr[4] := ShipToCountry + ' ' + SalesInvoiceHeader."Ship-to Post Code";
        ShipToAddr[5] := '';
        ShipToAddr[6] := SalesInvoiceHeader."Ship-to Contact";
    end;
